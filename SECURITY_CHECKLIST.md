...
* **รายละเอียด:**
  * การแสดงชื่อผู้พัฒนา `taurus42119` และลิงก์ Instagram `@kayvin.th` ใน [README.md](README.md) เป็นความตั้งใจของผู้พัฒนาสำหรับการเผยแพร่สู่สาธารณะ (Public Attribution)
